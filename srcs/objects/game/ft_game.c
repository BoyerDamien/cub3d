...
t_game ft_game(char **map, int win_size[2])
{
    ...
    new.wall_texture_N = ft_texture(new.window.mlx_ptr, "/Users/dess/Desktop/cub3d/textures/stone.xpm");
    new.wall_texture_S = ft_texture(new.window.mlx_ptr, "/Users/dess/Desktop/cub3d/textures/grass.xpm");
    new.wall_texture_O = ft_texture(new.window.mlx_ptr, "/Users/dess/Desktop/cub3d/textures/metal.xpm");
    new.wall_texture_E = ft_texture(new.window.mlx_ptr, "/Users/dess/Desktop/cub3d/textures/wall1.xpm");
    return (new);
}